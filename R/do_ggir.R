...
doGGIR <- function(indir) {
  ...
  windowsizes = c(1,600,3600), # w1: for acceleration and angle metrics; w2 non-wear and signal clipping; w3 is the window length of data used for non-wear detection and by default 3600 seconds.
